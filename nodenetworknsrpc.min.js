...
function NodeNetworkRpc(e){var t=this;t.connected=!1,t._queueEmitter=new QueueEmitter,t.network=NodeNetwork(e),t.router=AgnosticRouter(),t._rpc=Rpc(),t.network.on("message",function(e){t._rpcMessage(e)}),t.network.on("address",function(e){t.address=e,void 0===e?(t.connected=!1,t.emit("disconnect")):(t.connected=!0,t.emit("connect"))}),["insert","remove"].forEach(function(e){t.network.on(e,function(){t.emit(e,Array.prototype.slice.call(arguments))})});var r={};this.config=Utils.objectMerge(r,e)}var Rpc=require("agnostic-rpc"),EventEmitter=require("wolfy87-eventemitter"),QueueEmitter=require("queue-emitter"),AgnosticRouter=require("agnostic-router"),NodeNetwork=require("node-network"),Utils=require("./Utils.js");NodeNetworkRpc.prototype.__proto__=EventEmitter.prototype,NodeNetworkRpc.prototype.queueOn=function(){this._queueEmitter.on.apply(this._queueEmitter,Array.prototype.slice.call(arguments))},NodeNetworkRpc.prototype.queueOnce=function(){this._queueEmitter.once.apply(this._queueEmitter,Array.prototype.slice.call(arguments))},NodeNetworkRpc.prototype.request=function(){var e=this;if(void 0===e.address)throw new Error("NO ADDRESS SET");var t=Utils.parseArgs(arguments,[{name:"destAddresses",level:1,validate:function(e,t){return"string"==typeof e&&"/"!=e[0]||Array.isArray(e)}},{name:"path",level:0,validate:function(e,t){return"string"==typeof e&&"/"==e[0]}},{name:"query",level:1,validate:function(e,t){return"object"==typeof e},default:{}},{name:"options",level:2,validate:function(e,t){return"object"==typeof e},default:{}},{name:"callback",level:1,validate:function(e,t){return"function"==typeof e}}]),r={query:{path:t.path,query:t.query,srcAddress:this.address},options:t.options};"function"==typeof t.callback?r.responseHandler=function(e,r){"function"==typeof t.callback&&(e?t.callback(e):"object"!=typeof r?t.callback("response_not_object"):t.callback(r.error,r.response))}:r.responseHandler=void 0,r.destAddresses=t.destAddresses,e._queueEmitter.emit("outgoingRequest",r,function(t){if(t)"function"==typeof r.responseHandler&&r.responseHandler(t);else{var o=e._rpc.request(r.query,r.options,r.responseHandler);e.network.send(r.destAddresses,o)}})},NodeNetworkRpc.prototype._rpcMessage=function(e){var t=this;t._rpc.messageIsResponse(e)?t._queueEmitter.emit("incomingResponse",e,function(r){t._rpc.handleResponse(e)}):t._queueEmitter.emit("incomingRequest",e,function(r){var o=void 0,n=function(e,r){o=e.srcAddress;var n=function(e,t){r({error:e,response:t})},s=function(){n("not_found",null)};t.router.route("request",e.path,{query:e.query},n,s)},s=function(e){var r={destAddress:o,message:e};t._queueEmitter.emit("outgoingResponse",r,function(e){e||t.network.send(r.destAddress,r.message)})};t._rpc.handleRequest(e,n,s)})},NodeNetworkRpc.prototype.addConnection=function(e){this.network.addConnection.apply(this.network,Array.prototype.slice.call(arguments))},module.exports=function(e){return new NodeNetworkRpc(e)};
},{"./Utils.js":35,"agnostic-router":5,"agnostic-rpc":6,"node-network":37,"queue-emitter":53,"wolfy87-eventemitter":58}],35:[function(require,module,exports){

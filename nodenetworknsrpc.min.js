...
},{"url-pattern":54}],6:[function(require,module,exports){
...
},{"base64-js":8,"ieee754":29,"isarray":10}],10:[function(require,module,exports){
...
},{"./lib/Aggregate":12,"./lib/FauxmongoError":15,"./lib/GetBSONType":16,"./lib/MatchQuery":19,"./lib/Merge":20,"./lib/Project":22,"./lib/Update":27}],12:[function(require,module,exports){
...
},{"./AggregationOperators":13,"./AggregationStages":14,"./FauxmongoError":15,"./GetTypeStr":17}],13:[function(require,module,exports){
...
},{"./FauxmongoError":15,"./GetBSONType":16,"./GetTypeStr":17,"./MatchQuery":19,"./Set":25,"./Sorting":26}],14:[function(require,module,exports){
...
},{"./AggregationOperators":13,"./FauxmongoError":15,"./GetTypeStr":17,"./MatchQuery":19,"./Project":22,"./Sorting":26}],15:[function(require,module,exports){
...
},{"./GetTypeStr":17}],19:[function(require,module,exports){
...
},{"./GetTypeStr":17,"./MatchLeaves":18,"./MoreDollars":21,"./QueryOperators":23}],20:[function(require,module,exports){
...
},{"./GetTypeStr":17,"./MatchQuery":19,"./ResolveDollar":24}],21:[function(require,module,exports){
...
},{"./GetTypeStr":17}],22:[function(require,module,exports){
...
},{"./GetTypeStr":17,"./MatchQuery":19,"./ResolveDollar":24}],23:[function(require,module,exports){
...
},{"./GetTypeStr":17,"./MatchLeaves":18,"./MatchQuery":19}],24:[function(require,module,exports){
...
},{"./MatchQuery":19}],25:[function(require,module,exports){
...
},{"./GetTypeStr":17,"./MatchQuery":19}],26:[function(require,module,exports){
...
},{"./GetTypeStr":17}],27:[function(require,module,exports){
...
},{"./GetTypeStr":17,"./ResolveDollar":24,"./UpdateOperators":28}],28:[function(require,module,exports){
...
},{"./GetTypeStr":17,"./MatchLeaves":18,"./MatchQuery":19,"./MoreDollars":21,"./Sorting":26}],29:[function(require,module,exports){
...
function NodeNetworkRpc(e){var t=this;t.network=NodeNetwork(e),t.router=AgnosticRouter(),t._rpc=Rpc(),t.network.on("message",function(e){t._rpcMessage(e)}),t.network.on("address",function(e){t.address=e,void 0===e?t.emit("disconnect"):t.emit("connect")}),["insert","remove"].forEach(function(e){t.network.on(e,function(){t.emit(e,Array.prototype.slice.call(arguments))})});var r={};this.config=Utils.objectMerge(r,e)}var Rpc=require("agnostic-rpc"),EventEmitter=require("wolfy87-eventemitter"),AgnosticRouter=require("agnostic-router"),NodeNetwork=require("node-network"),Utils=require("./Utils.js");NodeNetworkRpc.prototype.__proto__=EventEmitter.prototype,NodeNetworkRpc.prototype.request=function(){if(void 0===this.address)throw new Error("NO ADDRESS SET");var e=Utils.parseArgs(arguments,[{name:"destAddresses",level:1,validate:function(e,t){return"string"==typeof e&&"/"!=e[0]||Array.isArray(e)}},{name:"path",level:0,validate:function(e,t){return"string"==typeof e&&"/"==e[0]}},{name:"query",level:1,validate:function(e,t){return"object"==typeof e},default:{}},{name:"options",level:2,validate:function(e,t){return"object"==typeof e},default:{}},{name:"callback",level:1,validate:function(e,t){return"function"==typeof e}}]),t={path:e.path,query:e.query,srcAddress:this.address};if("function"==typeof e.callback)var r=function(t,r){"function"==typeof e.callback&&(t?e.callback(t):"object"!=typeof r?e.callback("response_not_object"):e.callback(r.error,r.response))};else var r=void 0;var o=this._rpc.request(t,e.options,r);e.destAddresses;var n=e.destAddresses;this.network.send(n,o)},NodeNetworkRpc.prototype._rpcMessage=function(e){var t=this;if(this._rpc.messageIsResponse(e))this._rpc.handleResponse(e);else{var r=void 0,o=function(e,o){r=e.srcAddress;var n=function(e,t){o({error:e,response:t})},s=function(){n("not_found",null)};t.router.route("request",e.path,{query:e.query},n,s)},n=function(e){t.network.send(r,e)};this._rpc.handleRequest(e,o,n)}},NodeNetworkRpc.prototype.addConnection=function(e){this.network.addConnection.apply(this.network,Array.prototype.slice.call(arguments))},module.exports=function(e){return new NodeNetworkRpc(e)};
},{"./Utils.js":35,"agnostic-router":5,"agnostic-rpc":6,"node-network":37,"wolfy87-eventemitter":58}],35:[function(require,module,exports){
...
},{"./AddressManager":36,"./RouteTable":38,"./Utils":40,"_process":52,"agnostic-rpc":6,"wolfy87-eventemitter":58}],38:[function(require,module,exports){
...
},{"./FunctionUtils":42,"./OmsIntercept":44,"./OmsSubscriptions":49,"./Utils":51,"fauxmongo":11,"wolfy87-eventemitter":58}],47:[function(require,module,exports){
...
},{"fauxmongo":11}],51:[function(require,module,exports){
...
function DnsClient(e,r,i){console.log(i);var o=this;o._dnsDb=e,o._rpc=r,o._dnsServerAddress=i.dnsServer,o._apiBasePath=i.apiPath;var n=ApiBuilder.toObject(apiConfig,function(e,r,i,n){if("subscribeToGroup"==e)var s=function(e,r){e?n(e,null):o._dnsDb.groupsOplog.applyOp(r)};else var s=function(e,r){console.log(e,r)};console.log(arguments),console.log(o._apiBasePath+r),o._rpc.request(o._dnsServerAddress,o._apiBasePath+r,i.query,"object"==typeof apiConfig[e].requestOptions?apiConfig[e].requestOptions:{},s)});Utils.objectForEach(n,function(e,r){o[r]=function(){"string"==typeof o._dnsServerAddress?n[r].apply(n,Array.prototype.slice.call(arguments)):o._dnsDb.apply(n,Array.prototype.slice.call(arguments))}})}var Utils=require("./Utils"),ApiBuilder=require("agnostic-router-api-builder"),apiConfig=require("./apiConfig");module.exports=function(e,r,i){return new DnsClient(e,r,i)};
},{"./Utils":63,"./apiConfig":64,"agnostic-router-api-builder":3}],60:[function(require,module,exports){
function DnsDb(s){var o={removeEmptyGroups:!0,removeEmptyAddresses:!0,groupsOplogMax:1e3,addressesOplogMax:1e3};this._options=Utils.objectMerge(o,s),this.groups=Mongolocal({}),this.groupsOplog=Oms.OmsOplog(this.groups,{max:this._options.groupsOplogMax},{}),this.groupsOplogSubscriptions=Oms.OmsOplogSubscriptions(this.groupsOplog),this.addresses=Mongolocal({}),this.addressesOplog=Oms.OmsOplog(this.addresses,{max:this._options.addressesOplogMax},{}),this.addressesOplogSubscriptions=Oms.OmsOplogSubscriptions(this.addressesOplog)}var Mongolocal=require("mongolocal"),Oms=require("oms"),Utils=require("./Utils");DnsDb.prototype.addToGroup=function(s,o,e){function r(e){var r={_id:s},t=Utils.objectMerge(r,{$addToSet:{groups:o}});n.addresses.update(r,t,{upsert:!0},e)}function t(s,o){"function"==typeof e&&e(s,o)}var n=this;"string"!=typeof s?t("address_format_incorrect"):"string"!=typeof o?t("group_format_incorrect"):function(e){var r={_id:o},t=Utils.objectMerge(r,{$addToSet:{addresses:s}});n.groups.update(r,t,{upsert:!0},e)}(function(s){s?t(s,null):r(function(s){s?t(s,null):t(null,!0)})})},DnsDb.prototype.removeFromGroup=function(s,o,e){function r(e){var r={_id:s},t=Utils.objectMerge(r,{$pull:{groups:o}});n.addresses.update(r,t,function(s,o){if(s)e(s);else{if(n._options.removeEmptyAddresses){var t=Utils.objectMerge(r,{groups:{$size:0}});n.addresses.remove(t)}e(null)}})}function t(s,o){"function"==typeof e&&e(s,o)}var n=this;"string"!=typeof s?t("address_format_incorrect"):"string"!=typeof o?t("group_format_incorrect"):function(e){var r={_id:o},t=Utils.objectMerge(r,{$pull:{addresses:s}});n.groups.update(r,t,function(s,o){if(s)e(s);else{if(n._options.removeEmptyGroups){var t=Utils.objectMerge(r,{addresses:{$size:0}});n.groups.remove(t)}e(null)}})}(function(s){s?t(s,null):r(function(s){s?t(s,null):t(null,!0)})})},DnsDb.prototype.removeFromAllGroups=function(s,o){function e(s,e){"function"==typeof o&&o(s,e)}var r=this;"string"!=typeof s?e("address_format_incorrect"):r.addresses.findOne({_id:s},function(o,t){o?e(o,null):null==t?e(null,!0):(Array.isArray(t.groups)&&t.groups.forEach(function(o){r.removeFromGroup(s,o)}),e(null,!0))})},DnsDb.prototype.groupAddresses=function(s,o){this.groups.findOne({_id:s},function(s,e){s?o(s,null):null==e?o(null,[]):o(null,e.addresses)})},DnsDb.prototype.subscribeToGroup=function(){var s=Utils.parseArgs(arguments,[{name:"groupQuery",level:1,types:["object","string"],default:{}},{name:"oplogQuery",level:1,type:"object",default:{}},{name:"callback",level:0,type:"function"}]);this.groupsOplogSubscriptions.findSubscribe(s.groupQuery,s.oplogQuery,function(o,e){o?s.callback(o,null):s.callback(null,e)})},DnsDb.prototype.unsubscribe=function(s,o){"string"!=typeof s?o("subscription_undefined",null):this.groupsOplogSubscriptions.unsubscribe(s,o)},module.exports=function(s){return new DnsDb(s)};
},{"./Utils":63,"mongolocal":31,"oms":43}],61:[function(require,module,exports){
module.exports=function(r){var u=require("./apiConfig"),e=require("agnostic-router-api-builder"),o=require("oms"),i=o.OmsUtils,n=require("agnostic-router")();return n.use("/group/subscribe",function(u,e,o){r.subscribeToGroup("string"==typeof u.query.group?u.query.group:u.query.query,u.query.oplogQuery,function(r,u){r?e(r,null):e(null,i.operationDocMin(u))})}),e.toRouter(u,r,n),n};
},{"./apiConfig":64,"agnostic-router":5,"agnostic-router-api-builder":3,"oms":43}],62:[function(require,module,exports){
function DnsRpc(e){var n=this,t={dnsDb:{apiPath:"/api/dns",public:!1},dnsClient:{apiPath:"/api/dns"},network:{}};n._config=Utils.objectMerge(t,e),n._config.dnsDb=Utils.objectMerge(t.dnsDb,n._config.dnsDb),n._config.dnsClient=Utils.objectMerge(t.dnsClient,n._config.dnsClient),n.rpc=NodeNetworkRpc(n._config.network),n.network=n.rpc.network,n.router=n.rpc.router,["connect","disconnect"].forEach(function(e){n.rpc.on(e,function(){n.emit(e,Array.prototype.slice.call(arguments))})}),n.dnsDb=DnsDb(n._config.dnsDb),n.dnsClient=DnsClient(n.dnsDb,n.rpc,n._config.dnsClient),"boolean"==typeof n._config.dnsDb.public&&n._config.dnsDb.public&&n.router.use(n._config.dnsDb.apiPath,DnsDbRouter(n.dnsDb))}var EventEmitter=require("wolfy87-eventemitter"),NodeNetworkRpc=require("node-network-rpc"),DnsClient=require("./DnsClient"),DnsDb=require("./DnsDb"),DnsDbRouter=require("./DnsDbRouter"),Utils=require("./Utils");DnsRpc.prototype.__proto__=EventEmitter.prototype,DnsRpc.prototype.request=function(){function e(e,n){"function"==typeof t.callback&&t.callback(e,n)}var n=this,t=Utils.parseArgs(arguments,[{name:"destGroup",level:1,type:"string",default:n.config.defaultGroup},{name:"path",level:0,validate:function(e,n){return"string"==typeof e&&"/"==e[0]}},{name:"query",level:1,type:"object",default:{}},{name:"options",level:2,type:"object",default:{}},{name:"callback",level:1,type:"function"}]),r={groupLookup:!0,groupSubscribe:!1};t.options=Utils.objectMerge(r,t.options),"string"!=typeof t.destGroup?e("destGroup_undefined",null):n._dnsDb.groups.findOne(t.destGroup,function(r,o){r?e(r,null):null!=o?Array.isArray(o.addresses)&&o.addresses.length>0&&n._rpc.request(o.addresses,t.path,t.query,t.options,t.callback):t.options.groupLookup?t.options.groupSubscribe?n.groupSubscribe(t.destGroup,function(r,o){n._dnsDb.groups.findOne(t.destGroup,function(r,o){r?e(r,null):null==o||Array.isArray(o.addresses)&&0==o.addresses.length?e("empty_group",null):Array.isArray(o.addresses)&&o.addresses.length>0&&n._rpc.request(o.addresses,t.path,t.query,t.options,t.callback)})}):n.groupAddresses(t.destGroup,function(r,o){r?e(r,null):n._rpc.request(o,t.path,t.query,t.options,t.callback)}):e("group_undefined",null)})},DnsRpc.prototype.addConnection=function(){this.rpc.addConnection.apply(this.rpc,Array.prototype.slice.call(arguments))},module.exports=function(e){return new DnsRpc(e)};

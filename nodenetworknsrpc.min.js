...
function OmsOplogSubscriptions(o){var t=this;t.opLogCollection=o,t.docCollection=o.docCollection,t._subscriptions={},t._collectionQueries={},t._opLogQueries={},this.opLogCollection.on("insert",function(o){t._publish(o)})}var OmsSubscriptions=require("./OmsSubscriptions"),OmsUtils=require("./OmsUtils");OmsOplogSubscriptions.prototype.subscribeResume=function(o,t,e,i){var s=this;s.opLogCollection.findOne({_id:o},function(r,n){function c(){null==u?s.subscribe(t,e,i):s.opLogCollection.findOne({_id:u.data},function(o,r){if(o)i(o,null);else{var n=s.opLogSubscriptionComputedDoc(r,e,t);null!=n&&i(null,n),u=u.next,c()}})}if(r&&i(r,null),null==n)i("last_op_not_found",null);else{var u=s.opLogCollection.docsLinkedList.list[o];u=u.next,c()}})},OmsOplogSubscriptions.prototype.opLogSubscriptionComputedDoc=function(o,t,e){return OmsUtils.docMatch(o,t)?this.operationSubscriptionComputedDoc(o,e):null},OmsOplogSubscriptions.prototype.operationSubscriptionComputedDoc=function(o,t){switch(o.operation.operation){case"insert":case"remove":if(OmsUtils.docMatch(o.operation.doc,t))return this._objectMerge(o,{src:"subscription"});break;case"update":var e=OmsUtils.docMatch(o.operation.unmodifiedDoc,t),i=OmsUtils.docMatch(o.operation.modifiedDoc,t);if(e&&i)return o;if(e&&!i)var s=OmsUtils.operationObject("remove",[o.operation.unmodifiedDoc]);else{if(e||!i)return null;var s=OmsUtils.operationObject("insert",[o.operation.modifiedDoc])}var r=OmsUtils.operationDoc(s);return this._objectMerge(r,{_srcOpId:o._id,src:"subscription_translated"});default:throw new Error("unknown_event")}return null},OmsOplogSubscriptions.prototype.findSubscribe=function(o,t,e){function i(){console.log("SUB-CB",arguments),e.apply(s,Array.prototype.slice.call(arguments))}var s=this;s.docCollection.find(o,function(r,n){if(r)e(r,null);else{s.subscribe(o,t,i),n.forEach(function(o){var t=OmsUtils.operationObject("insert",[o]),i=s._objectMerge(OmsUtils.operationDoc(t),{src:"subscription_setup"});e(null,i)});var c=OmsUtils.operationObject("subscribe",["find-complete"]);e(null,OmsUtils.operationDoc(c))}})},OmsOplogSubscriptions.prototype.subscribe=function(o,t,e){var i=this._queryKey(this._collectionQueries,o);this._collectionQueries[i].usages++;var s=this._queryKey(this._opLogQueries,t);this._opLogQueries[s].usages++;var r=this._uniqueId();this._subscriptions[r]={collectionQueryKey:i,opLogQueryKey:s,callback:e};var n=OmsUtils.operationObject("subscribe",["subscribed",{subscriptionId:r}]);return e(null,OmsUtils.operationDoc(n)),r},OmsOplogSubscriptions.prototype._publish=function(o){console.log("PUBLISH",o);var t=this,e={},i={};this._objectForEach(t._subscriptions,function(s,r){var n=s.collectionQueryKey,c=t._collectionQueries[n].query,u=s.opLogQueryKey,l=t._opLogQueries[u].query;"boolean"!=typeof i[u]&&(i[u]=OmsUtils.docMatch(o,l)),i[u]&&(console.log("MATCHES",o),console.log("CQ",c),"boolean"!=typeof e[n]&&(e[n]=t.operationSubscriptionComputedDoc(o,c)),null!=e[n]&&(console.log("MATCH-2"),s.callback(null,e[n])))})},OmsOplogSubscriptions.prototype._queryKey=function(o,t){var e;for(e in o)if(o.hasOwnProperty(e)&&this._objectDeepEqual(o[e].query,t))return e;var i=this._uniqueId();return o[i]={usages:0,query:t},i},OmsOplogSubscriptions.prototype.unsubscribe=function(o){var t=this._subscriptions[o];if(!t)throw new Error("subscription_not_found");var e=t.collectionQueryKey,i=this._collectionQueries[e];--i.usages<=0&&delete this._collectionQueries[e];var s=t.opLogQueryKey,r=this._opLogQueries[s];--r.usages<=0&&delete this._opLogQueries[s]},OmsOplogSubscriptions.prototype._uniqueId=function(){function o(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return o()+o()+"-"+o()+"-"+o()+"-"+o()+"-"+o()+o()+o()},OmsOplogSubscriptions.prototype._objectDeepEqual=function(o,t){if("object"==typeof o&&null!=o&&"object"==typeof t&&null!=t){if(Object.keys(o).length!=Object.keys(t).length)return!1;for(var e in o){if(!t.hasOwnProperty(e))return!1;if(!this._objectDeepEqual(o[e],t[e]))return!1}return!0}return o===t},OmsOplogSubscriptions.prototype._objectForEach=function(o,t){var e;for(e in o)o.hasOwnProperty(e)&&t(o[e],e,o)},OmsOplogSubscriptions.prototype._objectMerge=function(){var o={};return this._objectForEach(arguments,function(t){for(var e in t)t.hasOwnProperty(e)&&(o[e]=t[e])}),o},module.exports=function(o){return new OmsOplogSubscriptions(o)};

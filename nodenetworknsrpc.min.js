...
function DnsClient(e,r,i){var n=this;n._dnsDb=e,n._rpc=r,n._dnsServerAddress=i.dnsServer,n._apiBasePath=i.apiPath;var s=ApiBuilder.toObject(apiConfig,function(e,r,i,s){if("subscribeToGroup"==e)var t=function(e,r){e?s(e,null):n._dnsDb.groupsOplog.applyOp(r)};else var t=s;n._rpc.request(n._dnsServerAddress,n._apiBasePath+r,i.query,"object"==typeof apiConfig[e].requestOptions?apiConfig[e].requestOptions:{},t)});Utils.objectForEach(s,function(e,r){n[r]=function(){"string"==typeof n._dnsServerAddress?s[r].apply(s,Array.prototype.slice.call(arguments)):n._dnsDb.apply(s,Array.prototype.slice.call(arguments))}})}var Utils=require("./Utils"),ApiBuilder=require("agnostic-router-api-builder"),apiConfig=require("./apiConfig");module.exports=function(e,r,i){return new DnsClient(e,r,i)};
